...
func CreateEnvironment(title string, magic string) (*GeneratorEnvironment, error) {
	...
	ret.InputFile = filesys.MustResolvePath(ret.Cwd, ret.InputFile)
...
func (env *GeneratorEnvironment) NewOutput(relpath string, prefix string) (*GoFileWriter, error) {
	r := NewGoFile(filesys.MustResolvePath(env.Cwd, relpath), env.Magic)
	r.Heading(prefix)
...
func (env *GeneratorEnvironment) FindGoMod() (string, error) {
	if env.goMod != "" {

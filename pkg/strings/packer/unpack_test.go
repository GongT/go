...
func TestUnpackMatchesNativeEndianBytes(t *testing.T) {
	...
	assertNext("NextUint", uint64(0x0102030405060708), func() (any, error) { return unpacker.NextUint() })
	...
	assertNext("NextByte", byte(0x41), func() (any, error) { return unpacker.NextByte() })
	...
	assertNext("NextInt", int64(-2), func() (any, error) { return unpacker.NextInt() })
	...
	peek := NewUnpack(binary.NativeEndian, []byte{0xaa, 0xbb, 0xcc})
